Public Class practCS
    ...
    Private Sub pct_MouseDoubleClick(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles pct.MouseDoubleClick
        If n > 2 Then
            ...
            If type = 1 Then
                ...
                rb3.Enabled = True
                rb3.Checked = True
                Label1.Text = "Побудуйте центр сиетрії"
                pct.Image = myBitmap
                type2 = 1
                type = 2
                prov1 = True
    ...
    Private Sub practCS_FormClosed(sender As System.Object, e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Application.Exit()
    End Sub
End Class